...
describe('at/tin', () => {
    it('format:591199013', () => {
        const result = validator.format('591199013', false);

        expect(result).toEqual('59-119/9013');
    });

    it('validate:59-119/9013', () => {
        const result = validator.validate('59-119/9013');
    ...
    it('validate:59-119/9012', () => {
        const result = validator.validate('59-119/9012');

        expect(result.error).toBeInstanceOf(exceptions.InvalidChecksum);
    });

    it('validate:00-119/9012', () => {
        const result = validator.validate('00-119/9012');
