...
describe('de/stnr', () => {
    ...
    it('validate:121/5752/5373', () => {
        const result = validator.validate('121/5752/5373');

        expect(result.isValid && result.compact).toEqual('12157525373');
    });

    it('validate:14/203/31601', () => {
        const result = validator.validate('14/203/31601');
    ...
    it('validate:0472480661811', () => {
        const result = validator.validate('0472480661811');
